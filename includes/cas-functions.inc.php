...
class wpCAS {
	...
	*/
	...
	// renvoie l'url de login, selon le contexte : int�gr� dans une IFRAME ou normal
	function get_url_login() {
		global $ent, $wpcas_options, $cas_configured;
		// Si cas est pas configur�, on retourne une url de login standard, pas li�e � une conf.
		if (!$cas_configured){
		...
		// }
		// Si on n'est pas en mode int�gr�
		// else {
	...
	function disable_function_pwd() {
		echo( __( 'Les fonctions de gestion des mots de passe sont d&eacute;sactiv&eacute;es car la plateforme est connect�e &agrave; l\'ENT '.NOM_ENT.'.', 'wpcas' ));
	}
...
// --------------------------------------------------------------------------------
//  D � b u t   d u   s c r i p t   d e   C A S i f i c a t i o n 
// --------------------------------------------------------------------------------
$ent = "laclasse";
